...
if (is_shop()) {
    ...
    $wp_rem_cs_shop_id = wc_get_page_id('shop');
    ...
    <div class="main-section">
        ...
        if (!empty($wp_rem_cs_xmlObject) && is_array($wp_rem_cs_xmlObject) && count($wp_rem_cs_xmlObject) > 1) {
            if ($pageSidebar === true) {
                    ...
                    <div class="page-section">
                        <div class="container">
                            ...
                            if (isset($image_url) && $image_url != '') {
                                ?>
                                <a href="<?php echo esc_url($image_url); ?>" data-rel="prettyPhoto" data-title="ref">
                                    <figure>
                                        <div class="page-featured-image">
                                            <img class="img-thumbnail cs-page-thumbnail" alt="img" data-src="" src="<?php echo esc_url($image_url); ?>">
                                        </div>
                                    </figure>
                                </a>
                                <?php
