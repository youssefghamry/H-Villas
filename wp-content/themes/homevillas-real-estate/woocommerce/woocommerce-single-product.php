...
if(function_exists('homevillas_filter_remove')){
   // homevillas_filter_remove('comment_form_field_comment', 'wp_rem_cs_filter_comment_form_field_comment', 60);
    homevillas_filter_remove('comment_form_field_comment', 'wp_rem_cs_form_field_comment', 10);
}
