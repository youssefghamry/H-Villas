    ...
    <div class="woocommerce-product-rating" itemprop="aggregateRating" itemscope itemtype="http://schema.org/AggregateRating">
        <div class="star-rating" title="<?php printf(wp_rem_cs_var_theme_text_srt('wp_rem_cs_rating_rating_outoff'), $average); ?>">
            <span style="width:<?php echo ( ( $average / 5 ) * 100 ); ?>%">
                <strong itemprop="ratingValue" class="rating"><?php echo wp_rem_cs_allow_special_char($average); ?></strong> <?php printf(wp_rem_cs_var_theme_text_srt('wp_rem_wooc_out_of_rating'), '<span itemprop="bestRating">', '</span>'); ?>
