...
<?php
        ...
        if ( isset($wp_rem_cs_var_header_bgcolor) && $wp_rem_cs_var_header_bgcolor != '' ) {
            ...
            .cookiealert .acceptcookies{
                background:<?php echo wp_rem_cs_allow_special_char($wp_rem_cs_var_header_bgcolor); ?> !important;
            }
            .cookiealert .acceptcookies{
                border-color:<?php echo wp_rem_cs_allow_special_char($wp_rem_cs_var_header_bgcolor); ?> !important;
            }
            <?php
        ...
        if ( isset($wp_rem_cs_var_footerbg_color) && $wp_rem_cs_var_footerbg_color != '' && isset( $wp_rem_cs_var_custom_footer_background ) ) {
