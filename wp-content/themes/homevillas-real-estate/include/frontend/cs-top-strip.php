                                ...
                                <li> <a href="#" class="lang_sel_sel icl-en"><i class="icon-earth-globe"></i><?php echo wp_rem_cs_var_theme_text_srt('wp_rem_cs_var_eng'); ?></a>
                                    <ul>
                                        <li class="icl-zh-hant"> 
                                            <a href="#">
                                                <div class="img-holder"><img src="<?php echo get_template_directory_uri(); ?>/assets/frontend/images/flag-france.png" alt="img"></div>
                                                <?php echo wp_rem_cs_var_theme_text_srt('wp_rem_cs_var_france'); ?>
                                            </a> 
                                        </li>
                                        <li class="icl-es"> 
                                            <a href="#">
                                                <div class="img-holder"><img src="<?php echo get_template_directory_uri(); ?>/assets/frontend/images/flag-germany.png" alt="img"></div>
                                                <?php echo wp_rem_cs_var_theme_text_srt('wp_rem_cs_var_germany'); ?>
                                            </a> 
                                        </li>
                                        <li class="icl-ar"> 
                                            <a href="#">
                                                <div class="img-holder"><img src="<?php echo get_template_directory_uri(); ?>/assets/frontend/images/flag-ar.png" alt="img"></div>
                                                <?php echo wp_rem_cs_var_theme_text_srt('wp_rem_cs_var_italy'); ?>
                                            </a> 
                                        </li>
                                        <li class="icl-ar"> 
                                            <a href="#">
                                                <div class="img-holder"><img src="<?php echo get_template_directory_uri(); ?>/assets/frontend/images/flag-iceland.png" alt="img"></div>
