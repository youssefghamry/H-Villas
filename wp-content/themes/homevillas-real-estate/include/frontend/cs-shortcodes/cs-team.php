    ...
    function wp_rem_cs_var_team_item_shortcode($atts, $content = "") {
        ...
        if ( $wp_rem_cs_var_team_views == 'medium' ) {
            ...
            if ( $wp_rem_cs_var_team_image <> '' ) {
                $html .= ' <figure><a href="' . esc_html($team_link) . '"><img src="' . esc_url($wp_rem_cs_var_team_image) . '" alt="img"></a></figure>';
            }
            $html .= ' </div>';
            ...
            if ( $wp_rem_cs_var_team_image <> '' ) {
                ...
                $html .= '<figure><a href="' . esc_html($team_link) . '"><img src="' . esc_url($wp_rem_cs_var_team_image) . '" alt="ref"></a></figure>';
                $html .= '</div>';
            }
            $html .= '<div class="text-holder">';
            if ( $wp_rem_cs_var_team_name <> '' ) {
            ...
            if ( $wp_rem_cs_var_team_image <> '' ) {
                $html .= '<div class="img-holder circle-img">';
                $html .= '<figure><a href="' . wp_rem_cs_allow_special_char($team_link) . '"><img src="' . esc_url($wp_rem_cs_var_team_image) . '" alt="ref"></a></figure>';
                $html .= '</div>';
            }
            $html .= '<div class="text-holder">';
            if ( $wp_rem_cs_var_team_name <> '' ) {
