...
if ( ! function_exists('wp_rem_cs_price_table_item') ) {
	...
	$wp_rem_cs_price_table_button_link = isset($wp_rem_cs_price_table_button_link) ? $wp_rem_cs_price_table_button_link : '';
        ...
        //simple view
        if ( $wp_rem_cs_price_table_style == 'classic' ) {
            $wp_rem_cs_var_price_table_item .= '<div class="pricetable-holder center ' . esc_html($active_class) . '" ' . wp_rem_cs_allow_special_char($wp_rem_cs_price_table_column_bgcolor) . '>';
            ...
            if ( (($wp_rem_cs_price_table_image_icon == 'image' || $wp_rem_cs_price_table_image_icon == '') && $wp_rem_cs_var_price_table_image != '') || (($wp_rem_cs_price_table_image_icon == 'icon' || $wp_rem_cs_price_table_image_icon == '') && $wp_rem_cs_price_table_icon_box != '') ) {
                ...
                if ( ($wp_rem_cs_price_table_image_icon == 'icon' || $wp_rem_cs_price_table_image_icon == '') && $wp_rem_cs_price_table_icon_box != '' ) {
                    ...
                    $wp_rem_cs_var_price_table_item .='<a href="#"><img src="' . esc_url($wp_rem_cs_var_price_table_image) . '" alt="img"></a>';
                }
                $wp_rem_cs_var_price_table_item .='</figure>';
            ...
            if ( isset($wp_rem_var_price_table_packages_list) && $wp_rem_var_price_table_packages_list != '' ) {
                ...
                if ( $wp_rem_cs_price_table_button_text <> '' ) {
                    $wp_rem_cs_var_price_table_item .= '<a  target="_blank" class="try-btn" style="background-color:' . wp_rem_cs_allow_special_char($wp_rem_cs_price_table_button_color_bg) . '!important; color:' . wp_rem_cs_allow_special_char($wp_rem_cs_price_table_button_color) . ' !important" href="' . esc_url($wp_rem_cs_price_table_button_link) . '">' . esc_html($wp_rem_cs_price_table_button_text) . '</a>';
                }
            }
            $wp_rem_cs_var_price_table_item .= '</div>';
            ...
            $wp_rem_cs_var_price_table_item .= ' <div class="cs-price">';
            $wp_rem_cs_var_price_table_item .= '<span ' . wp_rem_cs_allow_special_char($wp_rem_cs_price_table_column_bgcolor) . '>';
            ...
            if ( isset($wp_rem_var_price_table_packages_list) && $wp_rem_var_price_table_packages_list != '' ) {
                ...
                if ( $wp_rem_cs_price_table_button_text <> '' ) {
                    ...
                    $wp_rem_cs_var_price_table_item .= '<a style="background-color:' . wp_rem_cs_allow_special_char($wp_rem_cs_price_table_button_color_bg) . '!important; color:' . wp_rem_cs_allow_special_char($wp_rem_cs_price_table_button_color) . ' !important;" href="' . esc_url($wp_rem_cs_button_link) . '" class="text-color">' . esc_html($wp_rem_cs_price_table_button_text) . ' <i class="icon-controller-play"></i></a>';
                    $wp_rem_cs_var_price_table_item .= '</div>';
                }
            }
            $wp_rem_cs_var_price_table_item .= ' </div>';
            ...
            $wp_rem_cs_var_price_table_item .= '<div class="pricetable-holder modern center ' . esc_html($active_class) . '" ' . wp_rem_cs_allow_special_char($wp_rem_cs_price_table_column_bgcolor) . '>';
            if ( $wp_rem_cs_price_table_text != '' ) {
            ...
            if ( isset($wp_rem_var_price_table_packages_list) && $wp_rem_var_price_table_packages_list != '' ) {
                ...
                if ( $wp_rem_cs_price_table_button_text <> '' ) {
                    $wp_rem_cs_var_price_table_item .= '<a target="_blank" class="try-btn" style="background-color:' . wp_rem_cs_allow_special_char($wp_rem_cs_price_table_button_color_bg) . '!important; color:' . wp_rem_cs_allow_special_char($wp_rem_cs_price_table_button_color) . ' !important" href="' . esc_url($wp_rem_cs_button_link) . '" >' . esc_html($wp_rem_cs_price_table_button_text) . '</a>';
                }
            }
            $wp_rem_cs_var_price_table_item .= '</div>';
            $wp_rem_cs_var_price_table_item .= do_shortcode($content);
