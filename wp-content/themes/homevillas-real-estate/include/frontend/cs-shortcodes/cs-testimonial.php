        ...
        if ( $wp_rem_cs_var_testimonial_view == 'modern' ) {
            ...
            if ( ! empty($content_array) ) {
                foreach ( $content_array as $content_single ) {
                    $html .= wp_rem_cs_allow_special_char($content_single);
                }
            }
        ...
        if ( $wp_rem_cs_var_testimonial_view == 'modern' ) {
            if ( $image_url <> '' ) {
                $html .='<li class="swiper-pagination-switch">
                                            <figure>
                                                <a href="' . esc_url($wp_rem_cs_var_testimonial_link) . '"><img src="' . esc_url($image_url) . '" alt="ref"></a>
                                            </figure>
                                        </li>';
            }
            ...
            if ( $image_bg_url <> '' ) {
                $html .='<div class="img-holder">';
                $html .='<figure><img src="' . esc_url($image_bg_url) . '" alt="img"></figure>';
                $html .='</div>';
            }
            $html .='<div class="testimonial-description">';
            if ( $image_url <> '' ) {
                $html .='<div class="img-holder">';
                $html .='<figure><img src="' . esc_url($image_url) . '" alt="img"></figure>';
                $html .='</div>';
            }
            $html .='<div class="text-holder">';
            $html .='<p>' . do_shortcode($content) . '</p>';
