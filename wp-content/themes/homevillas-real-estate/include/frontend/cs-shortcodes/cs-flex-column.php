    ...
    function wp_rem_cs_var_column( $atts, $content = "" ) {
       ...
       $wp_rem_var_column_seperator_style = isset( $wp_rem_var_column_seperator_style ) ? $wp_rem_var_column_seperator_style : '';
        ...
        if ( isset( $column_class ) && $column_class <> '' ) {
            $html_column .= '<div class="' . wp_rem_cs_allow_special_char( $column_class ) . '">';
        }
        ...
        $html_column .= '<div  class="column-content ' . esc_html( $wp_rem_cs_column_bg_class ) . '" ' . wp_rem_cs_allow_special_char( $style_string ) . '>';
