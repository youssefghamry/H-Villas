        ...
        if ( isset($column_container) ) {
            ...
            if ( isset($wp_rem_cs_section_background_option) && $wp_rem_cs_section_background_option == 'section-custom-background-image' ) {
                ...
                if(function_exists('homevillas_global_session')){
                    $SERVER_NAME = homevillas_global_session("SERVER_NAME");
                }
                    ...
                    if ( isset($wp_rem_cs_section_video_url) && ! empty($wp_rem_cs_section_video_url) ) {
                        ...
                        if ( $wp_rem_cs_section_video_autoplay == 'yes' ) {
                            ...
                            if ( $string_exists === false ) {
                                ...
                                if ( $wp_rem_cs_section_video_mute == 'yes' ) {
                                    $section_video_element = str_replace($if, $if.' id="ytplayer', $section_video_element); // youtube autoplay
                                    ?>
                                    <script>
                                        // 2. This code loads the I_F_r_a_m_e Player API code asynchronously.
                                        var tag = document.createElement('script');
                                        tag.src = "https://www.youtube.com/<?php echo wp_rem_cs_allow_special_char($if_rame); ?>_api";
                                ...
                                $src = $doc->getElementsByTagName($if_rame)->item(0)->getAttribute('src');
                                $section_video_element = str_replace($src, $src . '?autoplay=1&loop=1', $section_video_element); // vimeo autoplay
                                $section_video_element = str_replace($if, $if.' frameborder="0" id="myvideo" ', $section_video_element); // youtube autoplay
                            }
                        }
                    }
                            ...
                            if ( isset($wp_rem_cs_layout) && ( $wp_rem_cs_layout != '' || $wp_rem_cs_layout != 'none' ) ) {
                                ...
                                if ( $wp_rem_cs_var_section_title != '' || $wp_rem_cs_var_section_subtitle != '' ) {
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="section-title" <?php echo wp_rem_cs_allow_special_char($title_align); ?>>
