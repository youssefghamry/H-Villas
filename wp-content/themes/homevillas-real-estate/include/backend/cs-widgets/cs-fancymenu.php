...
if ( ! class_exists('wp_rem_fancy_menu') ) {
	...
	class wp_rem_fancy_menu extends WP_Widget {
		...
		function widget($args, $instance) {
			...
			$wp_rem_widget_title = wp_specialchars_decode(stripslashes($wp_rem_widget_title));
			...
			echo wp_rem_cs_allow_special_char($widget_html);
		}
    ...
    add_action('widgets_init', function() {
        function_exists('homevillas_widget_register') ? homevillas_widget_register('wp_rem_fancy_menu') : '';
    });
