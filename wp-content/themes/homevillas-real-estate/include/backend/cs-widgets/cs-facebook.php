...
if ( ! class_exists( 'wp_rem_cs_facebook_module' ) ) {
    ...
    class wp_rem_cs_facebook_module extends WP_Widget {
        ...
        function form( $instance ) {
            ...
            <p>
                <label for="<?php echo wp_rem_cs_allow_special_char($this->get_field_id( 'width' )); ?>"><?php echo esc_html( wp_rem_cs_var_theme_text_srt( 'wp_rem_cs_var_facebook_width' ) ); ?>
            ...
            <p>
                <label for="<?php echo wp_rem_cs_allow_special_char($this->get_field_id( 'likebox_height' )); ?>"><?php echo esc_html( wp_rem_cs_var_theme_text_srt( 'wp_rem_cs_var_facebook_lightbox_height' ) ); ?>
    ...
    add_action('widgets_init', function() {
        function_exists('homevillas_widget_register') ? homevillas_widget_register('wp_rem_cs_facebook_module') : '';
    });
