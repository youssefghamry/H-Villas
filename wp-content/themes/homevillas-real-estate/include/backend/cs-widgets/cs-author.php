...
class Wp_rem_cs_author extends WP_Widget {
	...
	if (!empty($user_query->results)) {
		...
		if ($user->ID == $author_id) {
		    ...
		    <div class="widget user-widget">
		        <div class="user-info">
		    	<div class="img-holder"><figure><a href="<?php echo esc_url($author_link); ?>"><?php echo wp_rem_cs_allow_special_char($author_avatar); ?></a></figure></div>
    ...
    add_action('widgets_init', function() {
        function_exists('homevillas_widget_register') ? homevillas_widget_register('Wp_rem_cs_author') : '';
    });
