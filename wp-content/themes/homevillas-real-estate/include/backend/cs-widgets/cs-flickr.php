...
if ( ! class_exists('Wp_rem_cs_Flickr') ) {
                    ...
                    if ( 'ok' === $user_info['stat'] ) {
                        ...
                        if ( 'ok' === $content['stat'] ) {
                            ...
                            foreach ( (array) $content['photos']['photo'] as $photo ) {
                                ...
                                echo '<figure> <img alt="img" src="' . esc_url($image_file) . '">';
                    ...
                    if ( get_option('flickr_gallery_data') <> '' ) {
                        ...
                        if ( isset($flick_data['photo_src']) ) :
                            ...
                            foreach ( $flick_data['photo_src'] as $ph ) {
                                echo '<li>';
                                echo '<div class="cs-media">';
                                echo '<figure> <img alt="img" src="' . esc_url($flick_data['photo_src'][$i]) . '">';
    ...
    add_action('widgets_init', function() {
        function_exists('homevillas_widget_register') ? homevillas_widget_register('wp_rem_cs_flickr') : '';
    });
