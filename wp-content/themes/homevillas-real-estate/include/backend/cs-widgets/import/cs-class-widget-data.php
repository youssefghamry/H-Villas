...
if ( ! class_exists('wp_rem_cs_var_widget_data') ) {
	...
	class wp_rem_cs_var_widget_data {
		...
		public static function enqueue_admin_scripts($hook) {
			...
			wp_localize_script('widget_data', 'widgets_url', array( 'widgets_url' => get_admin_url(false, 'widgets.php')));
		}
										...
										<div class="widgets">
											...
											foreach ( $widget_list as $widget ) :
												...
												<div class="import-form-row">
													<input class="<?php echo wp_rem_cs_allow_special_char($sidebar_name) == 'wp_inactive_widgets' ? 'inactive' : 'active'; ?> widget-checkbox" type="checkbox" name="<?php echo esc_attr($widget); ?>" id="<?php echo esc_attr('meta_' . $widget); ?>" />
											...
											<div class="sidebar">
												...
												<div class="widgets">
													...
													foreach ( $widget_list as $widget ) :
														...
														?>
														<div class="import-form-row">
															<input class="<?php echo wp_rem_cs_allow_special_char($sidebar_name) == 'wp_inactive_widgets' ? 'inactive' : 'active'; ?> widget-checkbox" type="checkbox" name="<?php echo esc_attr(printf('widgets[%s][%d]', $widget_type, $widget_type_index)); ?>" id="<?php echo esc_attr('meta_' . $widget); ?>" />
