    ...
    class wp_rem_cs_var_html_fields extends wp_rem_cs_var_form_fields {
        ...
        public function wp_rem_cs_var_opening_field( $params = '' ) {
			...
			if ( isset( $label_desc ) && $label_desc != '' ) {
                $wp_rem_cs_var_output .= '<p class="label-desc">' . wp_rem_cs_allow_special_char( $label_desc ) . '</p>';
            }
            $wp_rem_cs_var_output .= '
				</div>
        ...
        public function wp_rem_cs_form_layout_render( $params = '' ) {
            ...
            $wp_rem_cs_output .= '<img src="' . get_template_directory_uri() . '/assets/backend/images/no_sidebar.png"  alt="img" />';
            ...
            $wp_rem_cs_output .= '<span class="ss">';
            $wp_rem_cs_output .= '<img src="' . get_template_directory_uri() . '/assets/backend/images/sidebar_right.png" alt="img" />';
            $wp_rem_cs_output .= '</span>';
            ...
            $wp_rem_cs_output .= '<span class="ss">';
            $wp_rem_cs_output .= '<img src="' . get_template_directory_uri() . '/assets/backend/images/sidebar_left.png" alt="img" />';
            $wp_rem_cs_output .= '</span>';
        ...
        public function wp_rem_cs_var_upload_file_field( $params = '' ) {
            ...
            $wp_rem_cs_var_output .= '<div class="thumb-secs"> <img src="' . esc_url( $value ) . '" id="wp_rem_cs_var_' . sanitize_html_class( $id ) . wp_rem_cs_allow_special_char($wp_rem_cs_var_random_id) . '_img" width="100" alt="img" />';
            ...
            if ( isset( $fields_list ) && is_array( $fields_list ) ) {
                foreach ( $fields_list as $field_array ) {
                    if ( $field_array['type'] == 'text' ) {
                        ...
                        $wp_rem_cs_var_output .= '<ul id="gal-sortable">';
                        $wp_rem_cs_var_output .= '<li class="ui-state-default" id="">';
                        $wp_rem_cs_var_output .= '<div class="thumb-secs"> <img src="' . esc_url( $value ) . '" id="wp_rem_cs_var_' . sanitize_html_class( $id ) . '_img" width="100" alt="img" />';
