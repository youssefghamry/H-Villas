    ...
    function wp_rem_cs_var_register_required_plugins() {
        ...
        $plugins = array(
            ...
            array(
                ...
                'source' => '' . wp_rem_cs_server_protocol() . 'chimpgroup.com/wp-demo/download-plugin/homevillas/real-estate-framework.zip',
                'required' => true,
                'version' => '2.4',
                'force_activation' => false,
                'force_deactivation' => false,
            ...
            array(
                ...
                'source' => '' . wp_rem_cs_server_protocol() . 'chimpgroup.com/wp-demo/download-plugin/homevillas/wp-realestate-manager.zip',
                'required' => true,
                'version' => '2.4',
                'force_activation' => false,
                'force_deactivation' => false,
            ...
            array(
                ...
                'source' => '' . wp_rem_cs_server_protocol() . 'chimpgroup.com/wp-demo/download-plugin/homevillas/cs-icons-manager.zip',
                'required' => true,
                'version' => '2.4',
                'force_activation' => false,
                'force_deactivation' => false,
