                        ...
                        foreach ( $posts_array as $menu_post ) {
                            ...
                            if ( $post_thumbnail_id != '' ) {
                                ...
                                $post_media = '<div class="cs-media">
									<figure> <a href="' . esc_url( get_permalink( $menu_post->ID ) ) . '"><img src="' . (isset( $post_thumbnail_url[0] ) ? $post_thumbnail_url[0] : '') . '" alt="ref" /></a> </figure>
								</div>';
                            }
                    ...
                    if ( is_object( $category ) ) {
                        ...
                        foreach ( $posts_array as $menu_post ) {
                            ...
                            if ( $post_thumbnail_id != '' ) {
                                ...
                                $post_media = '
								<div class="cs-media">
									<figure> <a href="' . esc_url( get_permalink( $menu_post->ID ) ) . '"><img src="' . (isset( $post_thumbnail_url[0] ) ? $post_thumbnail_url[0] : '') . '" alt="img" /></a> </figure>
								</div>';
                            }
                            $post_title = wp_rem_cs_get_post_excerpt( $menu_post->post_title, 6 );
                            $html .= '
