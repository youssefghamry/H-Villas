...
if ( ! class_exists('wp_rem_cs_theme_all_strings_2') ) {
    ...
    class wp_rem_cs_theme_all_strings_2 {
        ...
        public function wp_rem_cs_theme_option_strings_callback($wp_rem_cs_var_static_text) {
            ...
            $wp_rem_cs_var_static_text['wp_rem_theme_option_marketplace_token'] = esc_html__('Marketplace Token', 'homevillas-real-estate');
            $wp_rem_cs_var_static_text['wp_rem_theme_option_marketplace_token_hint'] = esc_html__('Enter the Envato API Personal Token.', 'homevillas-real-estate');
            $wp_rem_cs_var_static_text['wp_rem_theme_option_secret_item_id'] = esc_html__('Item ID', 'homevillas-real-estate');
            $wp_rem_cs_var_static_text['wp_rem_theme_option_item_id_hint'] = esc_html__('Enter the Envato Item ID.', 'homevillas-real-estate');
