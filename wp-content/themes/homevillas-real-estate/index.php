                                        ...
                                        while ($query->have_posts()) : $query->the_post();
                                            ...
                                            <div <?php post_class('col-lg-12 col-md-12 col-sm-12 col-xs-12') ?>>
                                                <div class = "blog-post">
													...
													if($cs_views_counter > 1){
														$views_text = wp_rem_cs_var_theme_text_srt('wp_rem_cs_var_views');
													} else {
														$views_text = esc_html__('View', 'homevillas-real-estate');
													}
                                                    ?>
                                                    <div class = "text-holder">
                                                        <span class="post-views"><i class="icon-eye"></i><?php echo intval($cs_views_counter); ?> <?php echo wp_rem_cs_allow_special_char($views_text); ?></span>
