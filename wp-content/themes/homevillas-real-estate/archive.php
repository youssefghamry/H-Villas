                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="author-list-holder">
                                    <div class="img-holder">
                                        <figure><?php echo wp_rem_cs_allow_special_char($author_avatar); ?></figure>
                                    </div>
                        ...
                        if (category_description() || is_tag()) {
                            if (is_author()) {
                                ...
                                <div class="left-sp">
                                    ...
                                    <p><?php echo wp_rem_cs_allow_special_char($userdata->description); ?></p>
                                </div>
                                <?php
                            } elseif (is_category()) {
                                        ...
                                        if ($custom_query->have_posts()) {
                                            while ($custom_query->have_posts()) : $custom_query->the_post();
											    ...
											    <a href="javascript:void(0)"><img src="' . esc_url($wp_rem_var_src[0]) . '"></a>
                                                        ...
                                                        $cs_views_label = (intval($cs_views_counter) == 1)? wp_rem_cs_var_theme_text_srt('wp_rem_cs_var_archieve_view') : wp_rem_cs_var_theme_text_srt('wp_rem_cs_var_archieve_views');
                                                        ?>
                                                        <div class = "text-holder">
                                                            <span class="post-views"><i class="icon-eye"></i><?php echo intval($cs_views_counter); ?> <?php echo esc_html($cs_views_label); ?></span>
